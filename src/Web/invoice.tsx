...
export const invoicePreview = (globalData: any, colors: any) => {
  const script = `
    <!DOCTYPE html>
    <html lang="en">
                        ...
                        <table style="width: 100%;">
                            ...
                            <tr>
                                <td>
                                    ...
                                    }" alt="Business Logo" style="height: 120px;">
                                </td>
                                ...
                                <td colspan="2">
                                    <!-- Invoice Details -->
                                    <b> Invoice </b> <br>
                                    ${globalData?.invoice_number} <br>
                                    <b>DATE</b><br>
                                    <!-- Format the date -->
                                    <script>
                                        var originalDate = new Date(data.invoice_date);
                                        var options = {
                                            year: 'numeric',
                                            month: 'short',
                                            day: 'numeric',
                                ...
                                <td>
                                    <table style="width: 100%;">
                                        <tr>
                                            ...
                                            <td>${
                                              globalData?.invoice_subtotal
                                            } </td>
                                        </tr>
                                        <tr>
                                            <td style="width:25%;"><b>DISCOUNT( ${
                                              globalData?.invoice_discount_value
                                            } %)</b></td>
                                            <td>${
                                        ...
                                        <tr class="item">
                                            <td style="width:25%;"><b> ${
                                              globalData?.invoice_tax_label
                                            } </b></td>
                                            <td style="width:10%; text-align:right;"> ${
                                              globalData?.invoice_tax_rate
                                            } </td>
                                        </tr>
                                        <tr class="item">
