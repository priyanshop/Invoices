...
const SignatureView = forwardRef(({
  ...
  const source = useMemo(() => {
    ...
    html = html.replace(/<%cancel%>/g, cancelText);

    return { html };
  }, [customHtml, autoClear, trimWhitespace, rotated, imageType, webStyle, descriptionText, confirmText, clearText, dataURL, bgSrc, bgWidth, bgHeight,cancelText])
