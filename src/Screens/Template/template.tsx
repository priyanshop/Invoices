...
const colorsArray1 = ['#FF0000', '#00FF00', '#0000FF', '#FFFF00', '#FFA500', '#8B008B', '#FFC0CB'];
const colorsArray2 = ['#4CAF50', '#2196F3', '#FF5722', '#9C27B0', '#FF9800', '#607D8B', '#E91E63'];

const MyWebViewScreen = () => {
  const {t, i18n} = useTranslation();
  const dispatch = useDispatch();
  const [selectedWebViewIndex, setSelectedWebViewIndex] = useState(null);
  ...
  const handleWebViewPress = (index: any) => {
